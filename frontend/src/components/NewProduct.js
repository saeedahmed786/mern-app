   ...
   const addProducts = () => {
    return ( 
        ...
        <div className = 'container-fluid pt-4'>
          <div className = ' text-white text-center mb-5 ' style = {{height: '100px', background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}}>
           <h1 className = 'mt-2 pt-4'>Admin Dashboard</h1>
           </div>
           <div className = 'text-center'>
           <h2 className = 'text-white' style = {{ background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}}>Categories</h2>
           <button type = 'button' className = 'btn mt-3 mb-4' style = {{ background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}} data-toggle = 'modal' data-target = '#addcategoryModal'>Create a Caregory</button>
           </div>
           <ul className = 'list-group list-unstyled '>
            ...
            <div className = 'py-4'>
            <h1 className = ' text-center text-white' style = {{ background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}}>Deals</h1>
                <CreateDeals/>
           ...
           <h3 className = 'text-center font-weight-bold text-white' style = {{ background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}}>Products</h3>
            ...
            <div className = 'modal-content text-white' style = {{background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}}>
            ...
            <div className = 'modal-header bg-info'>
               ...
               <br/>
                ...
                <button type= 'submit' className = 'btn ' style = {{background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}}> { id? 'Update':'Create'}</button>
                <button type= 'submit' className = 'btn  close' style = {{background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}} data-dismiss = 'modal'>Close</button>
                </div>
        ...
        <div className = 'text-center pb-4'>
           <button type = 'button' className = 'btn' style = {{background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}} data-toggle = 'modal' data-target = '#addProductModal'>Create a Product</button>
           </div>
            ...
            <form onSubmit = {handlecategorySubmit}>
              <div className = 'modal-header bg-info'>
                ...
                <div className = 'modal-footer'>
                    <button className = 'btn close' style = {{background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}} data-dismiss = 'modal'>close</button>
                    <button type = 'submit' className = 'btn' style = {{background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}} >submit</button>
                </div>
               </form>
