        ...
        <div>
           ...
           <table class=" container table font-weigth-bold">
             ...
             <div className = ' container font-weight-bolder mb-4' style = {{border: '.04rem solid black'}}>
                   ...
                   {
                       cartItems.length > 0 ? 
                       <button onClick ={checkOutHandler} type = 'button' className = 'btn mb-3 pt-2' style = {{width: '300px',height: '60px', color: 'whitesmoke', background: 'radial-gradient( circle at top right, #16222A, #3A6073)'}}>Proceed to Checkout</button>
                       :
                       null
                   }
            </div> 
