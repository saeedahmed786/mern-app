 ...
 function Navbar(props) {
    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg h-25">
                        <Link className="navbar-brand pl-3" to="/" style = {{color: 'white'}}><img src = {logo} style = {{width: '100px'}}/></Link>
                    ...
                    <li className="nav-item pl-3">
                        ...
                        <i class="fas fa-store-alt"></i> Categories
                        </Link>
                        
                        </li>

                        <li className="nav-item pl-3">
                        <Link className="nav-link" to="/cart/:id"><i class="fas fa-shopping-cart"></i> Cart</Link>
                    </li>
                   
                 
                    
                    <li className="nav-item pl-3">
                        <Link className="nav-link" to="#"><i class="fas fa-address-card"></i> About</Link>
                    </li>
                    <li className="nav-item pl-3">
                        <Link className="nav-link" to="#"><i class="fas fa-phone"></i> Contact</Link>
                    </li>
...

                    {
                        !isAuthenticated() && (
                            <li className="nav-item pl-3">
                             <Link className="nav-link ml-3" style = {{color: 'lightgrey'}} to="/signin"><i className="fas fa-sign-in-alt"></i> Login
                             </Link>
