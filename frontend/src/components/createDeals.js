    ...
    return (
        ...
        <div>
         <div className = 'text-center'>
           <button type = 'button' className = 'btn' style = {{ background: 'linear-gradient(135deg, #172a74, #21a9af)', color: 'lightgray'}} data-toggle = 'modal' data-target = '#addDealModal'>Create a Deal</button>
           </div>
